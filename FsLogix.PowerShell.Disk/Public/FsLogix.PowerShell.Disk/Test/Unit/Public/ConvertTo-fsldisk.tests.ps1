...
Describe $sut {
    ...
    Context -Name 'Outputs that should throw' {
        ...
        it 'Using non-existing convertTo'{
            $Invalid_input = { ConvertTo-FslDisk -path "C:\Users\danie\Documents\VHDModuleProject\ODFCTest2\test.4.vhdx" -convertTo vhdxasd} 
            $Invalid_input | should throw
        }
    ...
    Context -Name "Should not throw"{
        ...
        it 'Valid path'{
            $Valid_input = { ConvertTo-FslDisk -path "C:\Users\danie\Documents\VHDModuleProject\ODFCTest2\TestVHD2.vhd" -convertTo vhdx -overwrite }
