<#
    ...
    .EXAMPLE
    ReSize-FSLDisk -SizeBytes 5gb -Path C:\Users\danie\test1.vhdx -newPath C:\Users\*\Desktop
    Will resize test1.vhdx to 5gb and store it in Desktop
    ...
    .EXAMPLE
    Resize-FSLDisk -SizeBytes 15gb -Percent 20 -Path C:\Users\Danie\test1.vhdx -newPath C:\users\Danie\Desktop
    Will resize test1.vhdx to 20% percent bigger than 15gb, and place the vhd onto the user's desktop.
#>
function Resize-FslDisk {
    ...
    Param (
        ...
        [string]$LogPath = "C:\Users\danie\Documents\OSTProject\Resize-FslDisk.log"
    )
            ...
            PROCESS {
                ...
                switch ($PSCmdlet.ParameterSetName) {
                    ...
                    LOG {
                        ...
                        $logmessage | Add-Content -Path $Path -ErrorAction SilentlyContinue
                    }
                }
    ...
    PROCESS {
        ...
        foreach ($vhd in $vhds) {
            ...
            if($SizeBytes -eq 0){
                $info = $vhd | get-vhd | Select-Object Size
                $SizeBytes = $info.Size
            }
            if($Percent -ne 0){
