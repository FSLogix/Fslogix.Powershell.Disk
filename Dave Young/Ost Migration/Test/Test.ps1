...
$Old_OST_Location       = "C:\Users\danie\Documents\VHDModuleProject\ODFCTest"          #Location of the ost files
$New_OST_Location       = "ODFC"                                #Destination for Ost files within VHD
$FsLogix_VHDLocation    = "C:\Users\danie\Documents\VHDModuleProject\ODFCtest3"  #Location of FsLogix VHD
